...
// import { View, Text, Modal, TouchableOpacity, Platform, StyleSheet, FlatList, DeviceEventEmitter } from 'react-native';
...
//     }
//     handleBack = () => {
//         DeviceEventEmitter.emit("onClosePicker", true)
...
//         item, index
//     }) => {
//         const { label, value, textCenter,isItem } = this.props;
//         return (
//             <TouchableOpacity
//                 onPress={() => this.handleSelectd(isItem?item:item[value])}
//             >
...
//                                 ?
//                                 (
//                                     <Text style={textStyle ? textStyle : styles.textWhite}>{this.handleLabel(source, selectedValue, value, label, textCenter)}</Text>)
//                                 :
//                                 (<Text style={stylePlaceholder ? stylePlaceholder : { color: placeholderColor ? placeholderColor : styles.txtMainTitle.color }}>
//                                     {placeholder}
//                                 </Text>)
//                             }
