...
export const XWALLET_API = {
    GET_FIAT_DEPOSIT_LOGS:`${EXCHANGE_URL}api/v1/wallet/get-fiat-deposit-logs/`,//{accId}/{pageIndex}/{pageSize}
    GET_COIN_DEPOSIT_LOG:`${EXCHANGE_URL}api/v1/wallet/get-coin-deposit-logs/`,//{accId}/{pageIndex}/{pageSize}
    GET_FIAT_WITHDRAW_LOGS:`${EXCHANGE_URL}api/v1/wallet/get-fiat-withdrawal-logs/`,//{accId}/{pageIndex}/{pageSize}
    GET_COIN_WITHDRAW_LOG:`${EXCHANGE_URL}api/v1/wallet/get-coin-withdrawals-logs/`,//{accId}/{pageIndex}/{pageSize}
    GET_COIN_BY_TYPE:`${EXCHANGE_URL}api/v1/wallet/get-coin-by-type/`,//{WalletType}
    GET_SWAP_ORDER_BOOKS:`${EXCHANGE_URL}api/v1/wallet/get-swap-order-books/`,//{accId}/{pageIndex}/{pageSize}
}
//Socket API
export const SOCKET_URL = env === "dev" ? 'http://54.169.88.171:6873/signalrHub?uid=' : 'https://market-watch.financex.io/signalrHub?uid=' //uid is user id response when user login
