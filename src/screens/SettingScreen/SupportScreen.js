...
const SupportScreen = ({componentId}) => {
  const data = [
    {
    ...
    {
      textLeft: 'Join us on Telegram',
      iconLeft: <Tl />,
      iconRight: true,
      onPress: () => Linking.openURL(linkSupport.telegram),
    },
    {
      textLeft: 'Email Support',
      iconLeft: <Email />,
      iconRight: true,
      onPress: () => Linking.openURL(`mailto:${linkSupport.email}`),
    },
