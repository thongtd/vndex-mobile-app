...
export default function Step2Kyc({componentId}) {
  return (
    <Container isScroll componentId={componentId} hasBack title={'Update KYC'.t()}>
      ...
      <Button textSubmit={"NEXT".t()} textClose={"Come back".t()} onSubmit={()=> pushSingleScreenApp(componentId,STEP3KYC_SCREEN)} isButtonCircle={false} isSubmit isClose spaceVertical={30} />
    </Container>
  );
}
