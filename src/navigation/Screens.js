...
export const SYMBOLS_SCREEN = 'vndex.title.SymbolsScreen';
export const SYMBOL_SCREEN = 'vndex.title.SymbolScreen';
...
export const FEEDBACK_SCREEN = 'vndex.title.FEEDBACK_SCREEN';
